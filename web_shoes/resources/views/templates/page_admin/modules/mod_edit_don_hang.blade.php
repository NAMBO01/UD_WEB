    ...
    <div class="panel-body">
        <form class="form-horizontal" action="" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <input type="text" name="dia_chi_nguoi_nhan" class="form-control" value="{{ $thong_tin_don_hang->dia_chi_nguoi_nhan }}">
                    <span class="help-block"></span>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <input type="text" name="dia_chi_nguoi_nhan" class="form-control" value="{{ $thong_tin_don_hang->tong_tien }}">
                    <span class="help-block"></span>
                </div>
            </div>
            <div class="form-group">

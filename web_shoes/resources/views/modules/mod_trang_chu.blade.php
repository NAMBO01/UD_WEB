    ...
    <div class="shoes-grid">
        ...
        <div class="product-left">
            ...
            <div class="col-md-4 chain-grid">
                <a href="/single?id_sp={{ $mau_ao_moi->ID }}"><img class="img-responsive chain" src="images/hinh_sp/{{ $mau_ao_moi->hinh }}" alt=" " /></a>
                ...
                <div class="grid-chain-bottom">
                    ...
                    <div class="star-price">
                        ...
                        <a class="now-get get-cart" href="gio-hang?id_sp={{ $mau_ao_moi->ID }}" data-id-sp="{{ $mau_ao_moi->ID }}">THÊM VÀO GIỎ HÀNG</a>
                        <div class="clearfix"> </div>
                    </div>
        ...
        <div class="product-left">
            ...
            <div class="col-md-4 chain-grid">
                <a href="/single?id_sp={{ $mau_giay_moi->ID }}"><img class="img-responsive chain" src="images/hinh_sp/{{ $mau_giay_moi->hinh }}" alt=" " /></a>
                <span class="star"> </span>
                <div class="grid-chain-bottom">
                    ...
                    <div class="star-price">
                        ...
                        <a class="now-get get-cart" href="gio-hang?id_sp={{ $mau_giay_moi->ID }}" data-id-sp="{{ $mau_giay_moi->ID }}">THÊM
                            VÀO GIỎ HÀNG</a>
                        <div class="clearfix"> </div>
                    </div>
                </div>

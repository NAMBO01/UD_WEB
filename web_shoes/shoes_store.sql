...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Mar 12, 2023 at 05:47 AM
...
CREATE TABLE IF NOT EXISTS `loai_trang_thai` (
  ...
  `ten_trang_thai` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id`)
...
--
-- Table structure for table `ss_ct_don_hang`
--

DROP TABLE IF EXISTS `ss_ct_don_hang`;
CREATE TABLE IF NOT EXISTS `ss_ct_don_hang` (
  `ID` int NOT NULL AUTO_INCREMENT,
  `ID_don_hang` int DEFAULT NULL,
  `don_gia` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `thanh_tien` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
--
-- Dumping data for table `ss_ct_don_hang`
--

INSERT INTO `ss_ct_don_hang` (`ID`, `ID_don_hang`, `don_gia`, `thanh_tien`, `so_luong`, `id_sp`) VALUES
...
--
-- Table structure for table `ss_don_hang`
--

DROP TABLE IF EXISTS `ss_don_hang`;
CREATE TABLE IF NOT EXISTS `ss_don_hang` (
  `ID` int NOT NULL AUTO_INCREMENT,
  ...
  `dia_chi_nguoi_nhan` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `sdt_nguoi_nhan` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
--
-- Dumping data for table `ss_don_hang`
--

INSERT INTO `ss_don_hang` (`ID`, `ma_don_hang`, `tong_tien`, `ngay_dat`, `id_nguoi_dung`, `ho_ten_nguoi_nhan`, `email_nguoi_nhan`, `dia_chi_nguoi_nhan`, `sdt_nguoi_nhan`, `trang_thai`) VALUES
...
--
-- Table structure for table `ss_hinh_san_pham`
--

DROP TABLE IF EXISTS `ss_hinh_san_pham`;
CREATE TABLE IF NOT EXISTS `ss_hinh_san_pham` (
  `id_hinh` int NOT NULL AUTO_INCREMENT,
  `id_sp` int NOT NULL,
...
--
-- Dumping data for table `ss_hinh_san_pham`
--

INSERT INTO `ss_hinh_san_pham` (`id_hinh`, `id_sp`, `ten_hinh`) VALUES
...
--
-- Table structure for table `ss_loai_san_pham`
--

DROP TABLE IF EXISTS `ss_loai_san_pham`;
CREATE TABLE IF NOT EXISTS `ss_loai_san_pham` (
  `ID_loai_sp` int NOT NULL,
  `ten_loai_sp` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `sap_xep` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `id_loai_cha` int DEFAULT NULL,
  `trang_thai` int NOT NULL,
  PRIMARY KEY (`ID_loai_sp`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Dumping data for table `ss_loai_san_pham`
--

INSERT INTO `ss_loai_san_pham` (`ID_loai_sp`, `ten_loai_sp`, `sap_xep`, `id_loai_cha`, `trang_thai`) VALUES
(20, 'Giày', NULL, 0, 1),
...
--
-- Table structure for table `ss_loai_thanh_vien`
--

DROP TABLE IF EXISTS `ss_loai_thanh_vien`;
CREATE TABLE IF NOT EXISTS `ss_loai_thanh_vien` (
  `ID` int NOT NULL AUTO_INCREMENT,
  `ten_loai_user` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`ID`)
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Dumping data for table `ss_loai_thanh_vien`
--

INSERT INTO `ss_loai_thanh_vien` (`ID`, `ten_loai_user`) VALUES
(1, 'thành viên'),
(2, 'VIP cấp bạc'),
(3, 'VIP cấp vàng'),
(4, 'VIP cấp kim cương'),
...
--
-- Table structure for table `ss_loai_tin_tuc`
--

DROP TABLE IF EXISTS `ss_loai_tin_tuc`;
CREATE TABLE IF NOT EXISTS `ss_loai_tin_tuc` (
  `ID` int NOT NULL,
  `ten_loai_tin` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `alias` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Dumping data for table `ss_loai_tin_tuc`
--

INSERT INTO `ss_loai_tin_tuc` (`ID`, `ten_loai_tin`, `alias`) VALUES
(1, 'giảm giá', NULL);

-- --------------------------------------------------------

--
-- Table structure for table `ss_nha_san_xuat`
--

DROP TABLE IF EXISTS `ss_nha_san_xuat`;
CREATE TABLE IF NOT EXISTS `ss_nha_san_xuat` (
  `ID` int NOT NULL AUTO_INCREMENT,
  `ten_nha_san_xuat` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci DEFAULT NULL,
  `dia_chi` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci DEFAULT NULL,
  `email` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci DEFAULT NULL,
  `sdt` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`ID`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_unicode_ci;

--
-- Dumping data for table `ss_nha_san_xuat`
--

INSERT INTO `ss_nha_san_xuat` (`ID`, `ten_nha_san_xuat`, `dia_chi`, `email`, `sdt`) VALUES
...
--
-- Table structure for table `ss_notice`
--
...
CREATE TABLE IF NOT EXISTS `ss_notice` (
  ...
  `trang_thai_cu` int DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `fk_trang_thai` (`id_don_hang`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_unicode_ci;

--
-- Dumping data for table `ss_notice`
--

INSERT INTO `ss_notice` (`id`, `email`, `id_don_hang`, `trang_thai_moi`, `trang_thai_cu`) VALUES
(1, 'hainam011201@gmail.com', 1, 0, NULL);

-- --------------------------------------------------------

--
-- Table structure for table `ss_san_pham`
--

DROP TABLE IF EXISTS `ss_san_pham`;
CREATE TABLE IF NOT EXISTS `ss_san_pham` (
  `ID` int NOT NULL AUTO_INCREMENT,
  `id_loai_sp` int NOT NULL,
  `ten_san_pham` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci DEFAULT NULL,
  `gioi_thieu` text CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci,
  `don_gia` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci DEFAULT NULL,
  `gia_giam` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci DEFAULT NULL,
  `sku` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci DEFAULT NULL,
  `noi_bat` tinyint DEFAULT NULL,
  `trang_thai` tinyint DEFAULT NULL,
...
--
-- Dumping data for table `ss_san_pham`
--

INSERT INTO `ss_san_pham` (`ID`, `id_loai_sp`, `ten_san_pham`, `gioi_thieu`, `don_gia`, `gia_giam`, `sku`, `noi_bat`, `trang_thai`, `id_nha_san_xuat`, `hinh`, `ngay_san_xuat`) VALUES
...
(32, 20, 'ADIDAS CAMO LINEAR HOODIE', NULL, '900000', '650000', 'EI9728', 0, 1, 3, NULL, NULL),
...
(42, 20, 'ÁO THUN JORDAN PSG LOGO', NULL, '950000', '750000', 'DJ0402-100', 0, 1, 1, NULL, NULL),
...
(44, 27, 'ÁO THUN NIKE ICON', NULL, '790000', '690000', 'BV0629-382', 0, 1, 1, 'ÁO THUN NIKE ICON 1.png', NULL),
...
(93, 26, 'ADIDAS STAN SMITH DIAMOND', 'ADIDAS STAN SMITH \"DIAMOND\"\r\nCode: EE8483.\r\nPhối màu: Cloud White/Cloud White/Core Black.\r\nFit: True to size hoặc lên 0.5 - 1 size.\r\nĐề xuất: Sử dụng đi lại hằng ngày, đi chơi.\r\n', '1800000', '1350000', 'EE8483', 0, 1, 4, 'ADIDAS STAN SMITH DIAMOND 1.png', NULL),
(96, 20, 'ADIDAS CONTINENTAL VULC J', NULL, '1900000', '1650000', 'EF9074', 0, 0, 3, NULL, NULL),
(97, 20, 'ADIDAS ADIFOM Q OFF-WHITE', NULL, '00000', '3500000', '3', 0, 1, 2, NULL, NULL),
(99, 22, 'test 2', NULL, '2000000', '50000', '1', 1, 1, 3, NULL, NULL);

-- --------------------------------------------------------

--
-- Table structure for table `ss_search_null`
--

DROP TABLE IF EXISTS `ss_search_null`;
CREATE TABLE IF NOT EXISTS `ss_search_null` (
...
--
-- Table structure for table `ss_thanh_vien`
--

DROP TABLE IF EXISTS `ss_thanh_vien`;
CREATE TABLE IF NOT EXISTS `ss_thanh_vien` (
  `ID` int NOT NULL AUTO_INCREMENT,
  `ho` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `dien_thoai` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `id_phan_quyen` int DEFAULT NULL,
  `id_loai_user` int DEFAULT NULL,
  PRIMARY KEY (`ID`)
) ENGINE=InnoDB AUTO_INCREMENT=17 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Dumping data for table `ss_thanh_vien`
--

INSERT INTO `ss_thanh_vien` (`ID`, `ho`, `ten`, `tai_khoan`, `mat_khau`, `email`, `diem_tich_luy`, `ngay_dang_ky`, `active_code`, `thoi_gian_dang_nhap`, `dien_thoai`, `id_phan_quyen`, `id_loai_user`) VALUES
...
--
-- Table structure for table `ss_tin_tuc`
--

DROP TABLE IF EXISTS `ss_tin_tuc`;
CREATE TABLE IF NOT EXISTS `ss_tin_tuc` (
  `ID` int NOT NULL,
  ...
  `id_loai_tin_tuc` int DEFAULT NULL,
...
--
-- Dumping data for table `ss_tin_tuc`
--

INSERT INTO `ss_tin_tuc` (`ID`, `tieu_de`, `tom_tat`, `chi_tiet`, `id_loai_tin_tuc`, `hinh`, `ngay_dang`) VALUES
...
--
-- Table structure for table `ss_ton_kho`
--

DROP TABLE IF EXISTS `ss_ton_kho`;
CREATE TABLE IF NOT EXISTS `ss_ton_kho` (
  `ID` int NOT NULL,
  `id_sp` int NOT NULL,
  `size` int NOT NULL,
...
--
-- Dumping data for table `ss_ton_kho`
--

INSERT INTO `ss_ton_kho` (`ID`, `id_sp`, `size`, `so_luong`) VALUES
(1, 19, 43, 12),
(2, 19, 42, 14),
(3, 19, 44, 2),
(4, 91, 44, 100);
...
--
-- Table structure for table `ss_trang_thai`
--

DROP TABLE IF EXISTS `ss_trang_thai`;
CREATE TABLE IF NOT EXISTS `ss_trang_thai` (
  `id` int NOT NULL AUTO_INCREMENT,
  `id_don_hang` int DEFAULT NULL,
  `trang_thai_moi` int DEFAULT NULL,
  `trang_thai_cu` int DEFAULT NULL,
...
--
-- Dumping data for table `ss_trang_thai`
--

INSERT INTO `ss_trang_thai` (`id`, `id_don_hang`, `trang_thai_moi`, `trang_thai_cu`) VALUES
(2, 2, 3, NULL),
(3, 3, 3, NULL),
(4, 4, 2, NULL),
(5, 5, 2, 4),

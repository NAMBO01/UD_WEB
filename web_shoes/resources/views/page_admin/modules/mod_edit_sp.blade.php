        ...
        <div class="form_them_san_pham">
            ...
            ?>
                <div class="form-group">
                    ...
                    <div class="col-md-9">
                        <input type="text" name="ten_san_pham" id="ten_san_pham" class="form-control" value="<?php echo $ip->ten_san_pham; ?>" required="required" title="">
                    </div>
                </div>
            <?php
            }
            ...
            ?>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-9">
                        <input type="text" name="don_gia" id="don_gia" class="form-control" value="<?php echo $ip->don_gia; ?>" required="required" title="">
                    </div>
                </div>
                <div class="form-group">
                    <div class="col-md-3">
                    ...
                    <div class="col-md-9">
                        <input type="text" name="gia_giam" id="gia_giam" class="form-control" value="<?php echo $ip->gia_giam; ?>" required="required" title="">
                    </div>
                </div>
                <div class="form-group">
                    <div class="col-md-3">
                    ...
                    <div class="col-md-9">
                        <input type="text" name="sku" id="sku" class="form-control" value="<?php echo $ip->sku; ?>" required="required" title="">
                    </div>
                </div>
                <div class="form-group">
                    <div class="col-md-3">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-9">
                        ...
                        <input type="file" name="hinh" id="hinh" class="form-control" accept="image/png,image/jpg">
                        @foreach($info_product as $ip)
                        <div id="image-holder">
                            <img src="/images/hinh_sp/{{$ip->hinh}}" alt="thumb-image">
                        </div>
                        @endforeach
                    </div>
                    <script>
